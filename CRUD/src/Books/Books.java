...
public class Books extends javax.swing.JFrame {
    ...
    public Books() {
        ...
        BooksTable.getTableHeader().addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                String name = BooksTable.getColumnName(col);
                String filter = FilterTextField.getText().equals("") ? "null" : FilterTextField.getText();
                order = order.equals("DESC") ? "ASC" : "DESC";

                ResultSet result = Utils.FilterBooks(filter, name.toLowerCase(), order);

                System.out.println("Column index selected " + col + " " + name);

                ((DefaultTableModel) BooksTable.getModel()).setRowCount(0);
    ...
    private void initComponents() {
        ...
        OperationsToolBar.add(jSeparator1);

        FilterLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        FilterLabel.setText("Filter:");
        FilterLabel.setPreferredSize(new java.awt.Dimension(35, 16));
        OperationsToolBar.add(FilterLabel);

        FilterTextField.setToolTipText("Filter the books");
        FilterTextField.setPreferredSize(new java.awt.Dimension(214, 28));
        FilterTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FilterTextFieldActionPerformed(evt);
            }
        });
        OperationsToolBar.add(FilterTextField);
    ...
    private void FilterTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FilterTextFieldActionPerformed
        try {
            ResultSet result = Utils.FilterBooks(FilterTextField.getText(), "null", "null");
