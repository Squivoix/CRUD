...
public class UpdateBook extends javax.swing.JFrame {
    ...
    public UpdateBook(String[] values) {
        initComponents();
        
        id = Integer.parseInt(values[0]);
        UpdateLabel.setText("Update book " + values[2]);
        ISBNTextField.setText(values[1]);
        TitleTextField.setText(values[2]);
        AuthorTextField.setText(values[3]);
        PublisherTextField.setText(values[4]);
        YearTextField.setText(values[5]);
        ObsTextArea.setText(values[6]);        
    ...
    private void initComponents() {
        ...
        UpdateLabel.setText("Update book");
    ...
    private void ApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApplyButtonActionPerformed
        ...
        if(Utils.UpdateBookRegistry(id, data)) {
